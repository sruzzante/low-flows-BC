...
# This script runs routine 'C' of the ECA analysis (Appendix E)
...
stn_MC_result<-foreach(stn_MC_x = stn_MC_ls,
  ...
  # stn_MC_x = stn_MC_ls[[85]]
  # streamDataYrly = streamDataMonthly_ls[[85]]
  # data_x = WeatherData_ls[[85]]
  # bestModel_x = bestModels[[85]]
  ...
  fitQ7<- arima(resids,c(0,0,0))
  
  
  fitECA5<- arima(dataYearly2$ECA_5,c(0,0,0))
  fitECA10<-arima(dataYearly2$ECA_10,c(0,0,0))
  fitECA20<-arima(dataYearly2$ECA_20,c(0,0,0))
  fitECA60<-arima(dataYearly2$ECA_60,c(0,0,0))
